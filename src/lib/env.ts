...
export const GITHUB_AUTH_REDIRECT_URL = `https://club.dssvjit.in/auth/callback/github`;
...
export const GOOGLE_AUTH_REDIRECT_URL = `https://club.dssvjit.in/auth/callback/google`;
