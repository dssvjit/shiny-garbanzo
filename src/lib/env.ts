...
export const GITHUB_AUTH_REDIRECT_URL = `http://club.dssvjit.in/auth/callback/github`;
...
export const GOOGLE_AUTH_REDIRECT_URL = `http://club.dssvjit.in/auth/callback/google`;
